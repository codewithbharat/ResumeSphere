...
const Home = () => {
    ...
    return (
        <Layout>
            ...
            <div className="keyFeatures px-12 py-20 w-full h-fit bg-blue-300/80">
            ...
            <div className="how-it-works md:px-12 md:py-20  md:m-32 rounded-lg shadow-md h-fit bg-indigo-300/80 text-gray-600">
